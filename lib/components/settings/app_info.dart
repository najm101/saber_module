...
import 'package:saber_module/data/version.dart';
...
class AppInfo extends StatelessWidget {
  ...
  static final Uri privacyPolicyUrl = Uri.parse(
      'https://github.com/saber-notes/saber_module/blob/main/privacy_policy.md');
  static final Uri licenseUrl =
      Uri.parse('https://github.com/saber-notes/saber_module/blob/main/LICENSE.md');
  static final Uri releasesUrl =
      Uri.parse('https://github.com/saber-notes/saber_module/releases');
