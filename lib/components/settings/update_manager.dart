...
import 'package:saber_module/data/saber_version.dart';
import 'package:saber_module/data/version.dart' as version;
...
abstract class UpdateManager {
  ...
  static final Uri versionUrl = Uri.parse(
      'https://raw.githubusercontent.com/saber-notes/saber_module/main/lib/data/version.dart');
  static final Uri apiUrl = Uri.parse(
      'https://api.github.com/repos/saber-notes/saber_module/releases/latest');
  ...
  static Future<String?> getChangelog({
    ...
    final url = 'https://raw.githubusercontent.com/saber-notes/saber_module/main/'
